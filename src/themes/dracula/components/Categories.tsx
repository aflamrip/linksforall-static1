        ...
        {categories?.map((category) => (
          <li key={category.id}>
            <button
              ...
              className={`whitespace-nowrap inline-flex px-3 py-4 text-dracula-comment hover:text-dracula-cyan font-semibold items-center sm:text-sm transition-colors ${
